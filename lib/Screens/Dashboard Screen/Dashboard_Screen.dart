...
import 'package:rto_flutter/Screens/Dashboard%20Screen/Controller_Dashboard_Screen.dart';
...
import '../../Six_Boxes/Categorywise_Book.dart';
import '../../Six_Boxes/vehicle_detail.dart';
import '../Login Screnn/Login_Screen.dart';

List<MVC_Dashboard_Screen> searchDataList = [];
...
class _DashboardState extends State<Dashboard> {
  ...
  bool chakedu4 = false;
  bool chakedu5 = false;
  final controller_get_allbook_data = Controller_Dashboard_Screen();
  ...
  Future _AllBook() async {
    delar_list_result =
        await controller_get_allbook_data.AllBookData('${widget.token}');
    // print("THE DELAR LIST IS " + delar_list_result);

    if (delar_list_result is List<MVC_Dashboard_Screen>) {
  ...
  Widget build(BuildContext context) {
    List<MVC_Dashboard_Screen> localdata = [];
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsets.fromLTRB(0, FixedHeight * 0.02, 0, 0),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              Container(
